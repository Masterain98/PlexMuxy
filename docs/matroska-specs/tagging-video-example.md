> **Source:** https://www.matroska.org/technical/tagging-video-example.html
...
The XML Tag files matching [mkvmerge’s DTD format](https://www.matroska.org/files/tags/matroskatags.dtd) for all the examples on this page can be found in a [zip file](https://dl.matroska.org/downloads/examples/videotags.zip).

## Basic movie

Here is a very basic example of how you would add the title, director, date of release and comment about a movie on one DVD ([XML version](https://www.matroska.org/files/tags/dune.xml)).
...
Now let’s see how a basic tagging of this file would work ([XML version](https://www.matroska.org/files/tags/simpsons-s01.xml)) :
...
[XML version](https://www.matroska.org/files/tags/simpsons-s01_14.xml)
...
[XML version](https://www.matroska.org/files/tags/simpsons-s01_58.xml)
...
[XML version](https://www.matroska.org/files/tags/simpsons-s01e01.xml)
...
[XML version](https://www.matroska.org/files/tags/simpsons-s01e02.xml)
...
[XML version](https://www.matroska.org/files/tags/simpsons-s01e05.xml)
...
[XML version](https://www.matroska.org/files/tags/trailer.xml)
